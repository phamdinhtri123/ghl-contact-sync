 ...
 * Description: Build reusable frontend forms, store submissions locally, sync contacts to GoHighLevel, and recover WooCommerce abandoned carts.
 * Version: 2.0.0
...
define( 'GHLCS_VERSION', '2.0.0' );
define( 'GHLCS_DB_VERSION', '0.2.1' );
